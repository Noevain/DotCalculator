...
public class Equations {
    ...
    public static unsafe (double AvgDamage, double NormalDamage, double CritDamage) CalcExpectedOutput(UIState* uiState, JobId jobId, double det, double critMult, double critRate, double dh, double ten, in LevelModifier lvlModifier, uint? ilvlSync, IlvlSyncType ilvlSyncType,int potency) {
        try {
            ...
            var baseMultiplier = Math.Floor(potency * atk * weaponDamage);
